...
export const defaultData:Tweet[] = [
  ...
  { tweet: 'Look this amazing challenge project #challenge #project', user: users[2], comments: 0, likes: 500, retweets: 100, date: Date.now() },
  { tweet: 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour', user: users[1], comments: 0, likes: 100, retweets: 50, date: Date.now() }
]
